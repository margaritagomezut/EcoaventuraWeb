...
<section class="max-w-7xl mx-auto px-6 py-16 grid grid-cols-1 lg:grid-cols-3 gap-12">
    ...
    <div class="lg:col-span-2">
        ...
        <div class="grid grid-cols-2 md:grid-cols-3 gap-4 mb-12">
            <img src="{{ asset('img/servicios/hotel-1.jpg') }}" class="rounded-lg object-cover h-40 w-full">
            <img src="{{ asset('img/servicios/hotel-2.jpg') }}" class="rounded-lg object-cover h-40 w-full">
            <img src="{{ asset('img/servicios/hotel-3.jpg') }}" class="rounded-lg object-cover h-40 w-full">
        </div>
